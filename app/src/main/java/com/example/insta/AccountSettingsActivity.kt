...
class AccountSettingsActivity : AppCompatActivity() {
    ...
    private fun uploadImageAndUpdateInfo() {
        ...
        when {
            ...
            full_name_profile_frag.text.toString() == "" -> {
                Toast.makeText(this, "Write Fullname", Toast.LENGTH_LONG).show()
            }
            username_profile_frag.text.toString() == "" -> {
                Toast.makeText(this, "Write Username", Toast.LENGTH_LONG).show()
            }
            bio_profile_frag.text.toString() == "" -> {
                Toast.makeText(this, "Write Bio", Toast.LENGTH_LONG).show()
            }
            else ->{
